{
    ...
    dirs = [
        ...
        { name = ".github"; text = ""; fg = "white"; }
        { name = ".npm"; text = ""; fg = "white"; }
        { name = "Desktop"; text = ""; fg = "white"; }
        { name = "Development"; text = ""; fg = "white"; }
        { name = "Documents"; text = ""; fg = "white"; }
        { name = "Downloads"; text = ""; fg = "white"; }
        { name = "Library"; text = ""; fg = "white"; }
        { name = "Movies"; text = ""; fg = "white"; }
        { name = "Music"; text = ""; fg = "white"; }
        { name = "Pictures"; text = ""; fg = "white"; }
        { name = "Public"; text = ""; fg = "white"; }
        { name = "Videos"; text = ""; fg = "white"; }
    ];
    ...
    files = [
        ...
        { name = ".clang-format"; text = ""; fg = "white"; }
        { name = ".clang-tidy"; text = ""; fg = "white"; }
        { name = ".codespellrc"; text = "󰓆"; fg = "white"; }
        { name = ".condarc"; text = ""; fg = "white"; }
        ...
        { name = "AUTHORS"; text = ""; fg = "white"; }
        { name = "AUTHORS.txt"; text = ""; fg = "white"; }
        ...
        { name = "bun.lock"; text = ""; fg = "white"; }
        { name = "bun.lockb"; text = ""; fg = "white"; }
        { name = "cantorrc"; text = ""; fg = "white"; }
        { name = "checkhealth"; text = "󰓙"; fg = "white"; }
        { name = "cmakelists.txt"; text = ""; fg = "white"; }
        { name = "code_of_conduct"; text = ""; fg = "white"; }
        { name = "code_of_conduct.md"; text = ""; fg = "white"; }
        ...
        { name = "Directory.Build.props"; text = ""; fg = "white"; }
        { name = "Directory.Build.targets"; text = ""; fg = "white"; }
        { name = "Directory.Packages.props"; text = ""; fg = "white"; }
        ...
        { name = "hyprlandd.conf"; text = ""; fg = "white"; }
        { name = "hyprlock.conf"; text = ""; fg = "white"; }
        { name = "hyprpaper.conf"; text = ""; fg = "white"; }
        { name = "hyprsunset.conf"; text = ""; fg = "white"; }
        ...
        { name = "index.theme"; text = ""; fg = "white"; }
        { name = "ionic.config.json"; text = ""; fg = "white"; }
        { name = "Jenkinsfile"; text = ""; fg = "white"; }
        { name = "justfile"; text = ""; fg = "white"; }
        ...
        { name = "playwright.config.cjs"; text = ""; fg = "white"; }
        { name = "playwright.config.cts"; text = ""; fg = "white"; }
        { name = "playwright.config.js"; text = ""; fg = "white"; }
        { name = "playwright.config.mjs"; text = ""; fg = "white"; }
        { name = "playwright.config.mts"; text = ""; fg = "white"; }
        { name = "playwright.config.ts"; text = ""; fg = "white"; }
        { name = "pnpm-lock.yaml"; text = ""; fg = "white"; }
        { name = "pnpm-workspace.yaml"; text = ""; fg = "white"; }
        ...
        { name = "prisma.config.mts"; text = ""; fg = "white"; }
        { name = "prisma.config.ts"; text = ""; fg = "white"; }
        ...
        { name = "readme"; text = "󰂺"; fg = "white"; }
        { name = "readme.md"; text = "󰂺"; fg = "white"; }
        ...
        { name = "vite.config.cjs"; text = ""; fg = "white"; }
        { name = "vite.config.cts"; text = ""; fg = "white"; }
        { name = "vite.config.js"; text = ""; fg = "white"; }
        { name = "vite.config.mjs"; text = ""; fg = "white"; }
        { name = "vite.config.mts"; text = ""; fg = "white"; }
        { name = "vite.config.ts"; text = ""; fg = "white"; }
        { name = "vitest.config.cjs"; text = ""; fg = "white"; }
        { name = "vitest.config.cts"; text = ""; fg = "white"; }
        { name = "vitest.config.js"; text = ""; fg = "white"; }
        { name = "vitest.config.mjs"; text = ""; fg = "white"; }
        { name = "vitest.config.mts"; text = ""; fg = "white"; }
        { name = "vitest.config.ts"; text = ""; fg = "white"; }
        { name = "vlcrc"; text = "󰕼"; fg = "white"; }
        { name = "webpack"; text = "󰜫"; fg = "white"; }
        { name = "weston.ini"; text = ""; fg = "white"; }
        { name = "workspace"; text = ""; fg = "white"; }
        { name = "wrangler.jsonc"; text = ""; fg = "white"; }
        { name = "wrangler.toml"; text = ""; fg = "white"; }
        { name = "xdph.conf"; text = ""; fg = "white"; }
    ...
    exts = [
        ...
        { name = "ada"; text = ""; fg = "white"; }
        { name = "adb"; text = ""; fg = "white"; }
        { name = "ads"; text = ""; fg = "white"; }
        ...
        { name = "cfc"; text = ""; fg = "white"; }
        { name = "cfg"; text = ""; fg = "white"; }
        { name = "cfm"; text = ""; fg = "white"; }
        ...
        { name = "feature"; text = ""; fg = "white"; }
        { name = "fish"; text = ""; fg = "white"; }
        { name = "flac"; text = ""; fg = "white"; }
        { name = "flc"; text = ""; fg = "white"; }
        { name = "flf"; text = ""; fg = "white"; }
        { name = "fnl"; text = ""; fg = "white"; }
        { name = "fodg"; text = ""; fg = "white"; }
        { name = "fodp"; text = ""; fg = "white"; }
        { name = "fods"; text = ""; fg = "white"; }
        { name = "fodt"; text = ""; fg = "white"; }
        { name = "frag"; text = ""; fg = "white"; }
        ...
        { name = "norg"; text = ""; fg = "white"; }
        { name = "nswag"; text = ""; fg = "white"; }
        { name = "nu"; text = ""; fg = "white"; }
        { name = "o"; text = ""; fg = "white"; }
        { name = "obj"; text = "󰆧"; fg = "white"; }
        { name = "odf"; text = ""; fg = "white"; }
        { name = "odg"; text = ""; fg = "white"; }
        { name = "odin"; text = "󰟢"; fg = "white"; }
        { name = "odp"; text = ""; fg = "white"; }
        { name = "ods"; text = ""; fg = "white"; }
        { name = "odt"; text = ""; fg = "white"; }
        { name = "oga"; text = ""; fg = "white"; }
        { name = "ogg"; text = ""; fg = "white"; }
        { name = "ogv"; text = ""; fg = "white"; }
        { name = "ogx"; text = ""; fg = "white"; }
        ...
        { name = "sig"; text = "󰘧"; fg = "white"; }
        { name = "signature"; text = "󰘧"; fg = "white"; }
        ...
        { name = "slnx"; text = ""; fg = "white"; }
        { name = "slvs"; text = "󰻫"; fg = "white"; }
        { name = "sml"; text = "󰘧"; fg = "white"; }
        ...
        { name = "stories.js"; text = ""; fg = "white"; }
        { name = "stories.jsx"; text = ""; fg = "white"; }
        { name = "stories.mjs"; text = ""; fg = "white"; }
        { name = "stories.svelte"; text = ""; fg = "white"; }
        { name = "stories.ts"; text = ""; fg = "white"; }
        { name = "stories.tsx"; text = ""; fg = "white"; }
        { name = "stories.vue"; text = ""; fg = "white"; }
    ...
    conds = [
        { text = ""; "if" = "orphan"; fg = "white"; }
        { text = ""; "if" = "link"; fg = "white"; }
        { text = ""; "if" = "block"; fg = "white"; }
        { text = ""; "if" = "char"; fg = "white"; }
        { text = ""; "if" = "fifo"; fg = "white"; }
        { text = ""; "if" = "sock"; fg = "white"; }
        { text = ""; "if" = "sticky"; fg = "white"; }
        { text = ""; "if" = "dummy"; fg = "white"; }
        { text = ""; "if" = "dir & hovered"; fg = "white"; }
        { text = ""; "if" = "dir"; fg = "white"; }
        { text = ""; "if" = "exec"; fg = "white"; }
        { text = ""; "if" = "!dir"; fg = "white"; }
    ];
}

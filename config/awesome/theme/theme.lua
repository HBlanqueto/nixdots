...
theme.layout_floating = gfs.get_configuration_dir() ..
                            "theme/layouts/floatingw.png"
theme.layout_magnifier = gfs.get_configuration_dir() ..
                             "theme/layouts/magnifierw.png"
theme.layout_max = gfs.get_configuration_dir() .. "theme/layouts/maxw.png"
theme.layout_fullscreen = gfs.get_configuration_dir() ..
                              "theme/layouts/fullscreenw.png"
theme.layout_tilebottom = gfs.get_configuration_dir() ..
                              "theme/layouts/tilebottomw.png"
theme.layout_tileleft = gfs.get_configuration_dir() ..
                            "theme/layouts/tileleftw.png"
theme.layout_tile = gfs.get_configuration_dir() .. "theme/layouts/tilew.png"
theme.layout_tiletop = gfs.get_configuration_dir() ..
                           "theme/layouts/tiletopw.png"
theme.layout_spiral = gfs.get_configuration_dir() .. "theme/layouts/spiralw.png"
theme.layout_dwindle = gfs.get_configuration_dir() ..
                           "theme/layouts/dwindlew.png"
theme.layout_cornernw = gfs.get_configuration_dir() ..
                            "theme/layouts/cornernww.png"
theme.layout_cornerne = gfs.get_configuration_dir() ..
                            "theme/layouts/cornernew.png"
theme.layout_cornersw = gfs.get_configuration_dir() ..
                            "theme/layouts/cornersww.png"
theme.layout_cornerse = gfs.get_configuration_dir() ..
                            "theme/layouts/cornersew.png"

-- [ Awesome Icon ]
theme.awesome_icon = theme_assets.awesome_icon(theme.menu_height, theme.xcolor8,
                                               theme.xcolor1)
